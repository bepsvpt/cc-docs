...
Auto Mode ist eine Forschungsvorschau, die allen Benutzern auf der Anthropic API verfügbar ist. Es ist nicht auf Drittanbieter-Providern verfügbar. Es erfordert Claude Sonnet 4.6, Opus 4.6 oder Opus 4.7.
