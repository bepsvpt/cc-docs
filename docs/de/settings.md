...
| `minimumVersion`                  | Verhindern Sie, dass der Auto-Updater unter eine bestimmte Version herabgestuft wird. Wird automatisch gesetzt, wenn Sie zum stabilen Kanal wechseln und sich entscheiden, auf der aktuellen Version zu bleiben, bis der stabile Kanal aufgeholt hat. Wird mit `autoUpdatesChannel` verwendet                                                                                                                                                                                                                                                                                                                                                               | `"2.1.100"`                                                                                                                      |
