...
| `defaultMode`                  | Standard-[Berechtigungsmodus](/de/permission-modes) beim Öffnen von Claude Code                                                                                                                                                                                                                       | `"acceptEdits"`                                                        |
...
| `filesystem.allowManagedReadPathsOnly` | (Nur verwaltete Einstellungen) Nur `allowRead`-Pfade aus verwalteten Einstellungen werden berücksichtigt. `allowRead`-Einträge aus Benutzer-, Projekt- und lokalen Einstellungen werden ignoriert. Standard: false                                                                                                                                                                                                   | `true`                          |
