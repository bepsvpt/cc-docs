...
| `CLAUDE_CODE_SUBAGENT_MODEL`     | Das Modell, das für alle [Subagents](/de/sub-agents#choose-a-model) verwendet werden soll. Überschreibt sowohl den `model`-Parameter pro Aufruf als auch die `model`-Frontmatter der Subagent-Definition |
