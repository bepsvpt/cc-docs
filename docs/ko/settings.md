...
| `minimumVersion`                  | 자동 업데이터가 특정 버전 아래로 다운그레이드되는 것을 방지합니다. 안정 채널로 전환할 때 현재 버전에 머물기로 선택할 때 자동으로 설정됩니다. `autoUpdatesChannel`과 함께 사용됨                                                                                                                                                                                                                                                  | `"2.1.85"`                                                                                                                     |
...
| `viewMode`                        | 시작 시 기본 트랜스크립트 보기 모드: `"default"`, `"verbose"` 또는 `"focus"`. 설정되면 sticky Ctrl+O 선택을 재정의합니다                                                                                                                                                                                                                                                                     | `"verbose"`                                                                                                                    |
