...
| `CLAUDE_CODE_SUBAGENT_MODEL`     | Le modèle à utiliser pour tous les [subagents](/fr/sub-agents#choose-a-model). Remplace à la fois le paramètre `model` par invocation et le frontmatter `model` de la définition du subagent |
