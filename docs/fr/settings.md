...
| `minimumVersion`                  | Empêcher l'auto-updater de rétrograder en dessous d'une version spécifique. Défini automatiquement lors du passage au canal stable et du choix de rester sur la version actuelle jusqu'à ce que stable rattrape. Utilisé avec `autoUpdatesChannel`                                                                                                                                                                                                                                                                                                                                                                                                 | `"2.1.85"`                                                                                                                     |
...
| `viewMode`                        | Mode d'affichage de transcript par défaut au démarrage : `"default"`, `"verbose"`, ou `"focus"`. Remplace la sélection sticky Ctrl+O quand défini                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `"verbose"`                                                                                                                    |
