...
| `minimumVersion`                  | Cegah auto-updater dari downgrade di bawah versi tertentu. Secara otomatis diatur saat beralih ke saluran stabil dan memilih untuk tetap pada versi saat ini sampai stabil mengejar. Digunakan dengan `autoUpdatesChannel`                                                                                                                                                                                                                                                                                                                                                                                                      | `"2.1.85"`                                                                                                                       |
...
| `viewMode`                        | Mode tampilan transkrip default saat startup: `"default"`, `"verbose"`, atau `"focus"`. Menimpa pemilihan Ctrl+O yang lengket saat diatur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `"verbose"`                                                                                                                      |
