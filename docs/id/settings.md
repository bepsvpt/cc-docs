...
| `defaultMode`                  | Mode [izin](/id/permission-modes) default saat membuka Claude Code                                                                                                                                                                                                        | `"acceptEdits"`                                                        |
...
| `filesystem.allowManagedReadPathsOnly` | (Pengaturan yang dikelola saja) Hanya jalur `allowRead` dari pengaturan yang dikelola yang dihormati. Entri `allowRead` dari pengaturan pengguna, proyek, dan lokal diabaikan. Default: false                                                                                                                                                                                  | `true`                          |
