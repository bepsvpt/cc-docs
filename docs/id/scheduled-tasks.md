...
<Note>
  Di Bedrock, Vertex AI, dan Microsoft Foundry, `/loop` tanpa prompt mencetak pesan penggunaan sebagai gantinya dari menjalankan prompt pemeliharaan.
</Note>
...
<Note>
  Di Bedrock, Vertex AI, dan Microsoft Foundry, `loop.md` tidak dibaca dan `/loop` tanpa prompt mencetak pesan penggunaan sebagai gantinya.
</Note>
