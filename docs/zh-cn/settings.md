...
| `minimumVersion`                  | 防止自动更新程序降级到特定版本以下。当切换到稳定渠道并选择保持在当前版本直到稳定追上时自动设置。与 `autoUpdatesChannel` 一起使用                                                                                                                                                                                                                         | `"2.1.85"`                                                                                                                    |
...
| `viewMode`                        | 启动时的默认记录视图模式：`"default"`、`"verbose"` 或 `"focus"`。设置时覆盖粘性 Ctrl+O 选择                                                                                                                                                                                                                                  | `"verbose"`                                                                                                                   |
