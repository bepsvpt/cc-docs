...
* **Ограничения платформы**: Claude Code в веб-интерфейсе работает только с кодом, размещённым в GitHub. Репозитории GitLab и другие не-GitHub репозитории не могут использоваться с облачными сессиями
