...
Попросите Claude построить ссылку из переменной окружения. Следующая команда выводит URL:
...
| Отредактировать окружение                       | Выберите значок параметров справа от имени окружения.                                                                                                                                                                                            |
