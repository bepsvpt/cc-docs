...
| **Используется для** | Стандарты кодирования, рабочие процессы, архитектура проекта | Команды сборки, инсайты отладки, предпочтения, которые обнаруживает Claude |
...
**Размер**: целевой показатель менее 200 строк на файл CLAUDE.md. Более длинные файлы потребляют больше контекста и снижают соблюдение. Если ваши инструкции становятся большими, разделите их с помощью [импортов](#import-additional-files) или файлов [`.claude/rules/`](#organize-rules-with-clauderules).
