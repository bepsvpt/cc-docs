...
Независимо от того, используете ли вы Claude API напрямую (1P) или получаете доступ через Amazon Bedrock или Google Vertex (3P), ваше существующее коммерческое соглашение будет применяться к использованию Claude Code, если мы не договорились об ином.
