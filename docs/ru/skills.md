...
<Note>
  Для встроенных команд, таких как `/help` и `/compact`, и встроенных skills, таких как `/debug` и `/simplify`, см. [справочник команд](/ru/commands).
...
Чтобы заблокировать skill от использования определённых инструментов, добавьте правила отказа в ваши [параметры разрешений](/ru/permissions) вместо этого.
