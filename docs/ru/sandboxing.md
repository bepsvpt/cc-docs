...
* **Использование компьютера на Desktop**: Когда Claude открывает приложения и управляет вашим экраном на macOS, он работает на вашем фактическом рабочем столе, а не в изолированной среде. Запросы разрешения для каждого приложения контролируют каждое приложение. См. [использование компьютера](/ru/desktop#let-claude-use-your-computer).
