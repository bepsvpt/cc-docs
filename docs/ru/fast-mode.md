...
* Цены на быстрый режим составляют $30/$150 MTok как на Opus 4.7, так и на Opus 4.6.
...
Opus 4.7 является стандартным режимом быстрого режима в Claude Code v2.1.142 и позже. Чтобы закрепить быстрый режим на Opus 4.6, установите `CLAUDE_CODE_OPUS_4_6_FAST_MODE_OVERRIDE=1`.
