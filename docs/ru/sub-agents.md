...
| Permissions             | Запросы выводятся в вашем терминале | [Предварительно одобрены](#run-subagents-in-foreground-or-background) перед запуском, затем автоматически отклонены |
