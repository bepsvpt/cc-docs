...
| `allowManagedMcpServersOnly`                   | Когда `true`, только `allowedMcpServers` из управляемых параметров учитываются. `deniedMcpServers` все еще объединяется из всех источников. См. [Управляемая конфигурация MCP](/ru/managed-mcp)                                                                                                                                                                |
