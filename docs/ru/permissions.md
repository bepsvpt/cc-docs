...
| `acceptEdits`       | Автоматически принимает разрешения на редактирование файлов для сеанса, кроме записей в защищенные каталоги                                                                                |
...
| [CLAUDE.md](/ru/memory) файлы и `.claude/rules/` | Только когда установлено `CLAUDE_CODE_ADDITIONAL_DIRECTORIES_CLAUDE_MD=1` |
