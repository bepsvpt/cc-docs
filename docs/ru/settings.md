...
| `minimumVersion`                  | Предотвратить понижение версии автоматического обновления ниже определенной версии. Автоматически устанавливается при переключении на стабильный канал и выборе остаться на текущей версии до тех пор, пока стабильный не наверстает упущенное. Используется с `autoUpdatesChannel`                                                                                                                                                                                                                                                                                                                               | `"2.1.85"`                                                                                                                      |
...
| `viewMode`                        | Режим просмотра стенограммы по умолчанию при запуске: `"default"`, `"verbose"` или `"focus"`. Переопределяет липкий выбор Ctrl+O при установке                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `"verbose"`                                                                                                                     |
