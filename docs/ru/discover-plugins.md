...
<Steps>
  ...
  <Step title="Используйте свой новый плагин">
    ...
    Каждый плагин работает по-разному. Проверьте описание плагина на вкладке **Discover** или на его домашней странице, чтобы узнать, какие skills и возможности он предоставляет.
  </Step>
</Steps>
