...
| Сочетание клавиш                  | Описание           | Примечания                                                                                                                                                                                                |
| :-------------------------------- | :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Удерживайте или нажимайте `Space` | Голосовая диктовка | Требует включения [голосовой диктовки](/ru/voice-dictation). Удерживайте для записи, или запустите `/voice tap` для переключения нажатием. [Переназначаемо](/ru/voice-dictation#rebind-the-dictation-key) |
