...
На Opus 4.7 усилие по умолчанию составляет `xhigh` для всех планов и поставщиков. На Opus 4.6 и Sonnet 4.6 значение по умолчанию — `high`, или `medium` на Pro и Max.
