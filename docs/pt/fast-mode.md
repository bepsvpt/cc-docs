...
* O preço do modo rápido é $30/$150 MTok tanto no Opus 4.7 quanto no Opus 4.6.
...
O Opus 4.7 é o padrão do modo rápido no Claude Code v2.1.142 e posterior. Para fixar o modo rápido no Opus 4.6, defina `CLAUDE_CODE_OPUS_4_6_FAST_MODE_OVERRIDE=1`.
...
* **Não disponível em provedores de nuvem de terceiros**: o modo rápido não está disponível no Amazon Bedrock, Google Vertex AI ou Microsoft Azure Foundry. O modo rápido está disponível através da API do Anthropic Console e para planos de assinatura Claude usando créditos de uso.
...
O modo rápido tem limites de taxa separados do Opus padrão. O modo rápido para Opus 4.7 e Opus 4.6 compartilham o mesmo pool de limite de taxa: o uso em qualquer modelo é extraído dos mesmos limites. Quando você atinge o limite de taxa do modo rápido ou fica sem créditos de uso:
