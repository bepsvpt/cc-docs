...
<Tabs>
  <Tab title="Terminal">
    ...
    <Tip>
      Veja [configuração avançada](/pt/setup) para opções de instalação, atualizações manuais ou instruções de desinstalação. Visite [troubleshooting de instalação](/pt/troubleshoot-install) se você encontrar problemas.
    </Tip>
  </Tab>
  ...
  <Tab title="Web">
    ...
    [Comece na web →](/pt/web-quickstart)
  </Tab>
...
<AccordionGroup>
  ...
  <Accordion title="Personalize com instruções, skills e hooks" icon="sliders">
    ...
    Crie [skills](/pt/skills) para empacotar fluxos de trabalho repetíveis que sua equipe pode compartilhar, como `/review-pr` ou `/deploy-staging`.
  ...
  <Accordion title="Execute equipes de agentes e construa agentes personalizados" icon="users">
    ...
    Para fluxos de trabalho totalmente personalizados, o [Agent SDK](/pt/agent-sdk/overview) permite que você construa seus próprios agentes alimentados pelas ferramentas e capacidades do Claude Code, com controle total sobre orquestração, acesso a ferramentas e permissões.
  </Accordion>
  ...
  <Accordion title="Agende tarefas recorrentes" icon="clock">
    ...
    * [Routines](/pt/routines) são executadas em infraestrutura gerenciada pela Anthropic, portanto continuam funcionando mesmo quando seu computador está desligado. Elas também podem ser acionadas por chamadas de API ou eventos do GitHub. Crie-as a partir da web, do aplicativo Desktop ou executando `/schedule` no CLI.
    * [Tarefas agendadas do Desktop](/pt/desktop-scheduled-tasks) são executadas em sua máquina, com acesso direto aos seus arquivos e ferramentas locais
  ...
  <Accordion title="Trabalhe de qualquer lugar" icon="globe">
    ...
    * Inicie uma tarefa de longa duração na [web](/pt/claude-code-on-the-web) ou [aplicativo iOS](https://apps.apple.com/app/claude-by-anthropic/id6473753684), depois puxe-a para seu terminal com `claude --teleport`
...
| Enviar eventos do Telegram, Discord, iMessage ou meus próprios webhooks para uma sessão | [Channels](/pt/channels)                                                                                                  |
...
| Executar Claude em um cronograma recorrente                                             | [Routines](/pt/routines) ou [Tarefas agendadas do Desktop](/pt/desktop-scheduled-tasks)                                   |
...
| Construir agentes personalizados para seus próprios fluxos de trabalho                  | [Agent SDK](/pt/agent-sdk/overview)                                                                                       |
