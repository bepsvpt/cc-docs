...
Auto mode é uma visualização de pesquisa disponível para todos os usuários na API Anthropic. Não está disponível em provedores de terceiros. Requer Claude Sonnet 4.6, Opus 4.6 ou Opus 4.7.
