...
| `CLAUDE_CODE_SUBAGENT_MODEL`     | O modelo a usar para todos os [subagents](/pt/sub-agents#choose-a-model). Substitui tanto o parâmetro `model` por invocação quanto o frontmatter `model` da definição do subagent |
