...
| `cleanupPeriodDays`               | Sessões inativas por mais tempo que este período são deletadas na inicialização (padrão: 30 dias, mínimo 1). Definir como `0` é rejeitado com um erro de validação. Para desabilitar escritas de transcrição completamente em modo não interativo (`-p`), use a flag `--no-session-persistence` ou a opção SDK `persistSession: false`; não há equivalente em modo interativo.                                                                                                                                                                                                                         | `20`                                                                                                                           |
