...
| `editorMode`                 | Modalità di associazione dei tasti per il prompt di input: `"normal"` o `"vim"`. Predefinito: `"normal"`. Scritto automaticamente quando esegui `/vim`. Appare in `/config` come **Key binding mode**                                                                                                                                             | `"vim"` |
...
| `defaultMode`                  | [Modalità di permesso](/it/permission-modes) predefinita quando si apre Claude Code                                                                                                                                                                                                    | `"acceptEdits"`                                                        |
...
| `filesystem.allowManagedReadPathsOnly` | (Solo impostazioni gestite) Solo i percorsi `allowRead` dalle impostazioni gestite sono rispettati. Le voci `allowRead` dalle impostazioni utente, progetto e locale vengono ignorate. Predefinito: false                                                                                                                                                                                                         | `true`                          |
