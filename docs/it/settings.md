...
| `minimumVersion`                  | Previeni che l'auto-updater esegua il downgrade al di sotto di una versione specifica. Impostato automaticamente quando si passa al canale stabile e si sceglie di rimanere sulla versione corrente fino a quando stabile non la raggiunge. Utilizzato con `autoUpdatesChannel`                                                                                                                                                                                                                                                                                                                                                                | `"2.1.85"`                                                                                                                    |
...
| `viewMode`                        | Modalità di visualizzazione della trascrizione predefinita all'avvio: `"default"`, `"verbose"`, o `"focus"`. Ignora la selezione sticky Ctrl+O quando impostato                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `"verbose"`                                                                                                                   |
