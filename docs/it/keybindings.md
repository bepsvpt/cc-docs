...
| `chat:killAgents`     | Ctrl+X Ctrl+K             | Termina tutti gli [agenti in background](/it/sub-agents#run-subagents-in-foreground-or-background) in esecuzione in questa sessione                                                        |
