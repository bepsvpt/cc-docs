...
Le attività hanno ambito di sessione: vivono nel processo Claude Code corrente e scompaiono quando si esce. Per la pianificazione durevole che sopravvive ai riavvii e viene eseguita senza una sessione di terminale attiva, vedere [Attività pianificate Desktop](/it/desktop#schedule-recurring-tasks) o [GitHub Actions](/it/github-actions).
