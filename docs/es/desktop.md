...
Auto mode es una vista previa de investigación disponible para todos los usuarios en la API de Anthropic. No está disponible en proveedores de terceros. Requiere Claude Sonnet 4.6, Opus 4.6 u Opus 4.7.
