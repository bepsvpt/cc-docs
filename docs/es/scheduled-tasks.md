...
<Note>
  En Bedrock, Vertex AI y Microsoft Foundry, `/loop` sin prompt imprime el mensaje de uso en su lugar en lugar de ejecutar el prompt de mantenimiento.
</Note>
...
<Note>
  En Bedrock, Vertex AI y Microsoft Foundry, `loop.md` no se lee y `/loop` sin prompt imprime el mensaje de uso en su lugar.
</Note>
