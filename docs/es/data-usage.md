...
De forma predeterminada, los informes de errores, la telemetría y los informes de errores se desactivan cuando se utiliza Bedrock, Vertex o Foundry. Las encuestas de calidad de sesión son la excepción y aparecen independientemente del proveedor. Puede optar por no participar en todo el tráfico no esencial, incluyendo encuestas, a la vez estableciendo `CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC`. Aquí están los comportamientos predeterminados completos:
